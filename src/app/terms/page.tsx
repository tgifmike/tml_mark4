...
const terms = () => {
	return (
		<main className="p-2">
			...
			<p className="p-2">Last updated: April 04, 2024</p>
			<p className="pl-10">
				Please read these terms and conditions carefully before using Our
				Service.
			</p>
			<h2 className="p-2 text-3xl">Interpretation and Definitions</h2>
			<h3 className="p-2 text-2xl">Interpretation</h3>
			<p className="p-2">
			...
			<h3 className="p-2 text-2xl">Definitions</h3>
			<p className="p-2">For the purposes of these Terms and Conditions:</p>
			<ul className="list-disc ml-8">
				<li className="p-2">
					<strong className="font-bold">Affiliate</strong> means an entity that
				...
				<li>
					...
					this Agreement) refers to The Manager Life.
				</li>
				<li>
				...
				<li>
					<strong>Website</strong> refers to The Manager Life, accessible from{' '}
					<a
						href="https://www.themanagerlife.com"
			...
			<h2 className="p-2 text-3xl">Acknowledgment</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Links to Other Websites</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Termination</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Limitation of Liability</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Governing Law</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Disputes Resolution</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">For European Union (EU) Users</h2>
			<p className="p-2">
				If You are a European Union consumer, you will benefit from any
				mandatory provisions of the law of the country in which You are
				resident.
			</p>
			<h2 className="p-2 text-3xl">United States Legal Compliance</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Severability and Waiver</h2>
			<h3 className="p-2 text-2xl">Severability</h3>
			<p className="p-2">
			...
			<h3 className="p-2 text-2xl">Waiver</h3>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Translation Interpretation</h2>
			<p className="p-2">
			...
			<h2 className="p-2 text-3xl">Changes to These Terms and Conditions</h2>
			<p className="p-2">
			...
			<h2 className="p-2 tex-2xl">Contact Us</h2>
			<p className="p-2">
			...
			<ul className="list-disc ml-8">
				<li>
					...
					<a
						href="https://www.themanagerlife.com/contact"
						rel="external nofollow noopener"
						target="_blank"
						className="underline"
					>
