...
//import '@/app/(Nav)/privacy/privacy.css';

export default function Privacy() {
	return (
		<main className="p-8">
			<h1 className="text-5xl">Privacy Policy</h1>
			<p className="p-2">Last updated: March 09, 2024</p>
			<p className="p-2">
			...
			<p className="p-2">For the purposes of this Privacy Policy:</p>
			<ul className="p-4 list-disc">
				...
				<li className="p-2">
					...
					<a
						href="http://www.themanagerlife.com"
						rel="external nofollow noopener"
						target="_blank"
					>
						http://www.themanagerlife.com
					</a>
				</li>
				<li className="p-2">
			...
			<h3 className="text-3xl">Types of Data Collected</h3>
			<h4 className="text-3xl">Personal Data</h4>
			<p className="p-2">
			...
			<ul className="list-disc p-4">
				...
				<li className="p-2">Usage Data</li>
			</ul>
			<h4 className="text-3xl">Usage Data</h4>
			<p className="p-2">
			...
			<h4 className="text-2xl">Tracking Technologies and Cookies</h4>
			<p className='p-2'>
			...
			<h3 className="text-3xl">Use of Your Personal Data</h3>
			<p className="p-2">
			...
			<h3 className="text-3xl">Retention of Your Personal Data</h3>
			<p className="p-2">
			...
			<h3 className="text-3xl">Delete Your Personal Data</h3>
			<p className="p-2">
			...
			<h3 className="text-4xl">Disclosure of Your Personal Data</h3>
			<h4 className="text-2xl">Business Transactions</h4>
			<p className="p-2">
			...
			<h4 className="text-4xl">Law enforcement</h4>
			<p className="p-2">
				Under certain circumstances, the Company may be required to disclose
				Your Personal Data if required to do so by law or in response to valid
				requests by public authorities (e.g. a court or a government agency).
			</p>
			<h4 className="text-4xl">Other legal requirements</h4>
			<p className="p-2">
				The Company may disclose Your Personal Data in the good faith belief
				that such action is necessary to:
			</p>
			<ul className="p-8 list-disc">
				<li className="p-2">Comply with a legal obligation</li>
				<li className="p-2">
				...
				<li className="p-2">Protect against legal liability</li>
			</ul>
			<h3 className="text-3xl">Security of Your Personal Data</h3>
			<p className="p-2">
			...
			<h2 className="text-3xl">Children's Privacy</h2>
			<p className="p-2">
			...
			<h2 className="text-3xl">Links to Other Websites</h2>
			<p className="p-2">
			...
			<ul className="list-disc p-6">
				<li className="privacyLI">By email: admin@themanagerlife.com</li>
				<li className="privacyLI">
					...
					<a
						...
						target="_blank"
					>
						https://www.themanagerlife.com/contact
					</a>
				</li>
			</ul>
		</main>
